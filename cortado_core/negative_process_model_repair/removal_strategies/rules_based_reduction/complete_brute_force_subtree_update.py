...
class CompleteBruteForceSubtreeUpdate(SubtreeUpdate):
    ...
    def apply_complete_brute_force_subtree_update_based_reduction(self) -> (ProcessTree, bool, bool, float, float, str):
        brute_force_results = []
    ...
    def get_all_loop_repetitions_encoding_combinations(
        ...
        if len(repetitions) > 1:
            min_num = min(max_number_of_loop_repetition_encodings, len(repetitions))
            ...
            combinations.append(repetitions)
